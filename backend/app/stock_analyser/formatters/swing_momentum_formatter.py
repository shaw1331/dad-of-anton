...
class SwingMomentumFormatter(BaseStockFormatter):
    """Formats stock data and news into a swing momentum analysis Markdown prompt."""
    ...
    def format(self, stock_data: dict, analyzed_news: list[dict], meta: dict) -> str:
        ...
        template = (_PROMPT_DIR / "swing_momentum_prompt.md").read_text()
...
StockDataFormatorFactory.register(SwingMomentumStrategy, SwingMomentumFormatter)
